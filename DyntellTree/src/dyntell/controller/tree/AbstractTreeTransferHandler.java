package dyntell.controller.tree;
...
public abstract class AbstractTreeTransferHandler implements DragGestureListener, DragSourceListener, DropTargetListener {
     ...
     protected AbstractTreeTransferHandler(DNDTreeHandler tree, int action, boolean drawIcon) {
          this.tree = tree;
          drawImage = drawIcon;
     ...
     public abstract boolean canPerformAction(DNDTreeHandler target, DefaultMutableTreeNode draggedNode, int action, Point location);

     public abstract boolean executeDrop(DNDTreeHandler tree, DefaultMutableTreeNode draggedNode, DefaultMutableTreeNode newParentNode, int action);
}